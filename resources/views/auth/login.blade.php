...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css"
        integrity="sha512-cTf9aImi42Xrq1zL5IU3yERgF/ZGJ8jFf0Y5SGgkPl5FtM2j4af0/TzX5lX0L/wJSsZ8trHfjW9CZGmH8ekyeg=="
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="mb-3 form-check">
                            @if (Route::has('password.request'))
                                <a class="form-text text-sm text-decoration-none"
                                    href="{{ route('password.request') }}">{{ __('Esqueceu sua senha?') }}</a>
                            @endif
                        </div>
                        ...
                        <div class="mt-3">
                            <p class="form-text text-sm text-muted">Não possui login? <a href="/register"
                                    class="text-decoration-none">{{ __('Clique aqui') }}</a></p>
                        </div>
                    </form>
                </div>
            </div>
